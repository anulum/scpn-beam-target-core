...
SCPN Beam Target Core — GOVERNANCE
-->
...
The project boundary — the assignment of `beam_target` and
`colliding_beam` to this repository, and the exclusions listed in the
