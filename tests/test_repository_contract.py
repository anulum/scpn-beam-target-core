...
# SCPN Beam Target Core — repository-level truth tests
...
REQUIRED_PATHS = (
    ...
    "src/scpn_beam_target_core/__init__.py",
    "src/scpn_beam_target_core/configuration.py",
    "src/scpn_beam_target_core/errors.py",
    "src/scpn_beam_target_core/observability.py",
    "src/scpn_beam_target_core/plan_envelope.py",
    "tests/data/plan_envelope_fixture.json",
    "src/scpn_beam_target_core/parameters.py",
...
def test_manifest_declares_exact_configuration_assignment() -> None:
    ...
    assert manifest["project"] == "SCPN-BEAM-TARGET-CORE"
...
def test_package_agrees_with_manifest_truth() -> None:
    ...
    from scpn_beam_target_core import OWNED_CONFIGURATIONS, RegistryBinding
