...
deployable artefact. Accelerator-architecture, target-state, and fuel
choices are configuration facets, not separate claims — and no
energy-gain claim of any kind is made or implied for this family. None of
the evidence-maturity states defined by the reactor family standard has
