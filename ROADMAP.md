...
- **Diagnostic and clock semantics** (landed 2026-08-31) — synthetic
  ...
  reference plan mirrors canonical practice (RF cavity/bunch-phase
  reference, target-outcome set, synthetic oscillator);
...
Beam-driven implosion ICF, the dense plasma focus, electrostatic
potential-well devices, magnetic-confinement systems, generic controller
mathematics, machine-protection logic, and any direct actuation path.
