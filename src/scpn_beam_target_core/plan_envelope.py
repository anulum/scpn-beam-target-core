...
# SCPN Beam Target Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-BEAM-TARGET-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_beam_target_core.observability.CATALOGUE_BINDING`.
    plan_identifier
